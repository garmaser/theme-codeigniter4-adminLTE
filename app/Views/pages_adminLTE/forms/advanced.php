        ...
        <div class="container-fluid">
            ...
            <div class="card card-default">
                ...
                <div class="card-footer">
                    Visit <a href="http://select2.github.io/">Select2 documentation</a> for more examples and information about
                    the plugin.
                </div>
            </div>
            <!-- /.card -->
            ...
            <div class="card card-default">
                ...
                <!-- /.card-body -->
                <div class="card-footer">
                    Visit <a href="http://github.com/istvan-ujjmeszaros/bootstrap-duallistbox#readme">Bootstrap Duallistbox</a> for more examples and information about
                    the plugin.
                </div>
            </div>
            <!-- /.card -->
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card card-primary">
                        ...
                        <div class="card-footer">
                            Visit <a href="http://getdatepicker.com/5-4/">tempusdominus </a> for more examples and information about
                            the plugin.
                        </div>
                        <!-- /.card-body -->
                    </div>
                    ...
                    <div class="card card-success">
                        ...
                        <!-- /.card-body -->
                        <div class="card-footer">
                            Many more skins available. <a href="http://bantikyan.github.io/icheck-bootstrap/">Documentation</a>
                        </div>
                    </div>
                    <!-- /.card -->
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-default">
                        ...
                        <!-- /.card-body -->
                        <div class="card-footer">
                            Visit <a href="http://github.com/Johann-S/bs-stepper/#how-to-use-it">bs-stepper documentation</a> for more examples and information about the plugin.
                        </div>
                    </div>
                    <!-- /.card -->
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-default">
                        ...
                        <!-- /.card-body -->
                        <div class="card-footer">
                            Visit <a href="http://www.dropzonejs.com">dropzone.js documentation</a> for more examples and information about the plugin.
                        </div>
                    </div>
                    <!-- /.card -->
                </div>
