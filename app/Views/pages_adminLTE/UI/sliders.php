...
<!-- INICIO: Page CSS-->
<!-- Ion Slider -->
<link rel="stylesheet" href="<?= base_url('adminLTE') ?>/plugins/ion-rangeslider/css/ion.rangeSlider.min.css">
<!-- bootstrap slider -->
<link rel="stylesheet" href="<?= base_url('adminLTE') ?>/plugins/bootstrap-slider/css/bootstrap-slider.min.css">
<!-- FIN: Page CSS-->
<?= $this->endSection() ?>
